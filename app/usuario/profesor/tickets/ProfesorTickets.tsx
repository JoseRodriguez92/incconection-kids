...
export default function ProfesorTickets() {
  ...
  // Solo los tickets del profesor actual
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .eq("is_internal", false) // ← no ve internos
  ...
  const startTour = useCallback(async () => {
    ...
    const steps: any[] = [
      {
        ...
        popover: {
          ...
          description:
            "Aquí puedes crear solicitudes de soporte y hacer seguimiento a su estado. Solo ves tus propios tickets.",
          side: "bottom",
          align: "start",
        },
      },
      {
        element: "#tour-tickets-nuevo",
        popover: {
          title: "➕ Nuevo Ticket",
          description:
      ...
      {
        element: "#tour-tickets-filtros",
        popover: {
          title: "🔍 Filtros",
          description:
            "Busca por título, descripción o código; filtra por estado (abierto, en proceso, cerrado) y por período académico para encontrar rápidamente la solicitud que necesitas.",
          side: "right",
        },
      },
    ];
    ...
    steps.push(
      {
        element: "#tour-tickets-detalle",
        popover: {
          title: "💬 Detalle y conversación",
          description:
            "Aquí ves la descripción completa del ticket y el hilo de mensajes con el soporte. Puedes agregar más información o comentarios mientras el ticket esté abierto. El estado solo lo cambia el equipo de soporte.",
          side: "left",
        },
      },
      {
        element: "#tour-tickets-boton",
        popover: {
          title: "❓ Tour de ayuda",
          description:
  ...
  return (
    <div className="p-6 space-y-6 mx-auto w-full">
        ...
        <div className="flex items-center gap-2">
          ...
          <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            <DialogTrigger asChild>
              <Button id="tour-tickets-nuevo" size="sm" className="gap-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* ── Lista ── */}
        <div id="tour-tickets-lista" className="lg:col-span-1">
          <Card>
            <CardHeader className="pb-3">
              ...
              <div id="tour-tickets-filtros" className="space-y-2">
        ...
        {/* ── Detalle ── */}
        <div id="tour-tickets-detalle" className="lg:col-span-2">
          {!selected ? (
            ...
            <Card className="flex flex-col">
              <CardHeader className="pb-3 border-b">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {/* Estado — solo lectura para el profesor */}
                  {selected.status && (
                    <span
              ...
              <CardContent className="space-y-4 pt-4">
                ...
                {/* Responder — deshabilitado si está cerrado */}
                {!selected.status?.is_closed && (
